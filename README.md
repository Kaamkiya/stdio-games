...
They are coded in [C++](https://devdocs.io/cpp/), [Go](https://go.dev/), [Python](https://docs.python.org/), [C](https://devdocs.io/c/), [Ruby](https://ruby-lang.org/), and [Java](https://java.com/).
